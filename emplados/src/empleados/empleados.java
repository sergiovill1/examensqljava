...
public class empleados {
    public static void main(String[] args) {
        ...
        try {
            ...
            rs = stm.executeQuery("SELECT empresa.nombre, empleado.nombre, empleado.ap_paterno, empleado.ap_materno, empleado.edad FROM empleado , empresa WHERE empleado.id_empresa = empresa.id_empresa ");
